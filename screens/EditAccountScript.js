      ...
      <ScrollView
        ...
        <View style={{flex: 1, justifyContent: 'flex-start'}}>
          ...
          <View style={{display:'flex',flexDirection:'row',marginTop:20}}>
              ...
              <Text style={{fontFamily:'Raleway-Regular',fontSize:12,color:'#5F5F5F',marginStart:10}}>This will add a globally available File or Script to your account which you can deploy to any server.</Text>
          </View>
          </View>
          <View
          style={{
