  ...
  >
      ...
      <View style={styles.action}>          
          <TextInput 
              ...
              left={<TextInput.Icon name="lock" onPress={updateSecureTextEntry}/>}
          />
      </View>
      ...
      <View style={styles.button}>
        <Button mode="contained" color='#018647' style={{width:"100%",}} onPress={()=>{loginHandle(token)}}>
          Log In
        </Button>
      </View>
      </>}
      ...
      <View style={styles.button}>
        ...
        :<Button icon="at" mode="flat" color='#018647' onPress={()=>{setLoginWithToken(false)}}>
        Login With Email
      </Button>
        }
